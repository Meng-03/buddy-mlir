module {
  ...
  ^bb3(%2: index):  // 2 preds: ^bb2, ^bb7
    %3 = arith.cmpi slt, %2, %c4_1 : index
    llvm.cond_br %3, ^bb4, ^bb8
  ^bb4:  // pred: ^bb3
  ...
  ^bb5(%4: index):  // 2 preds: ^bb4, ^bb6
    %5 = arith.cmpi slt, %4, %c4_4 : index
    llvm.cond_br %5, ^bb6, ^bb7
  ^bb6:  // pred: ^bb5
  ...
  ^bb9(%8: index):  // 2 preds: ^bb8, ^bb10
    %9 = arith.cmpi slt, %8, %c4_9 : index
    llvm.cond_br %9, ^bb10, ^bb11
  ^bb10:  // pred: ^bb9
    memref.store %cst, %alloc_0[%6, %8] : memref<4x4xf32>
    %10 = arith.addi %8, %c1_10 : index
    cf.br ^bb9(%10 : index)
  ^bb11:  // pred: ^bb9
    %11 = arith.addi %6, %c1_7 : index
    cf.br ^bb7(%11 : index)
  ^bb12:  // pred: ^bb7
    %c0_11 = arith.constant 0 : index
    %c4_12 = arith.constant 4 : index
    %c1_13 = arith.constant 1 : index
    cf.br ^bb13(%c0_11 : index)
  ^bb13(%12: index):  // 2 preds: ^bb12, ^bb17
    %13 = arith.cmpi slt, %12, %c4_12 : index
  ...
  ^bb15(%14: index):  // 2 preds: ^bb14, ^bb16
    %15 = arith.cmpi slt, %14, %c4_15 : index
    llvm.cond_br %15, ^bb16, ^bb17
  ^bb16:  // pred: ^bb15
    memref.store %cst, %alloc_1[%12, %14] : memref<4x4xf32>
    %16 = arith.addi %14, %c1_16 : index
    cf.br ^bb15(%16 : index)
  ^bb17:  // pred: ^bb15
    %17 = arith.addi %12, %c1_13 : index
    cf.br ^bb13(%17 : index)
  ^bb18:  // pred: ^bb13
