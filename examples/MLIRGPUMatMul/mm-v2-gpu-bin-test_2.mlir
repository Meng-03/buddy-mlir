module attributes {gpu.container_module} {
  ...
  llvm.func @main() {
    ...
    %13 = llvm.mlir.constant(1048576 : index) : i64
    ...
    %30 = llvm.mlir.constant(1048576 : index) : i64
    %31 = llvm.mlir.zero : !llvm.ptr
    %32 = llvm.getelementptr %31[%30] : (!llvm.ptr, i64) -> !llvm.ptr, f16
    ...
    %47 = llvm.mlir.constant(1048576 : index) : i64
    ...
    %62 = llvm.alloca %61 x !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %26, %62 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>, !llvm.ptr
    %63 = llvm.mlir.constant(2 : index) : i64
    %64 = llvm.mlir.undef : !llvm.struct<(i64, ptr)>
    %65 = llvm.insertvalue %63, %64[0] : !llvm.struct<(i64, ptr)> 
    %66 = llvm.insertvalue %62, %65[1] : !llvm.struct<(i64, ptr)> 
    %67 = llvm.mlir.constant(1 : index) : i64
    %68 = llvm.alloca %67 x !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %43, %68 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>, !llvm.ptr
    ...
    %74 = llvm.alloca %73 x !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %60, %74 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>, !llvm.ptr
    ...
    scf.for %arg0 = %1 to %6 step %3 {
      %122 = builtin.unrealized_conversion_cast %arg0 : index to i64
      scf.for %arg1 = %1 to %6 step %3 {
        %123 = builtin.unrealized_conversion_cast %arg1 : index to i64
        %124 = llvm.extractvalue %26[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
        %125 = llvm.mlir.constant(1024 : index) : i64
        %126 = llvm.mul %122, %125  : i64
        %127 = llvm.add %126, %123  : i64
        %128 = llvm.getelementptr %124[%127] : (!llvm.ptr, i64) -> !llvm.ptr, f16
        llvm.store %8, %128 : f16, !llvm.ptr
        %129 = llvm.extractvalue %43[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
        %130 = llvm.mlir.constant(1024 : index) : i64
        %131 = llvm.mul %122, %130  : i64
        %132 = llvm.add %131, %123  : i64
        %133 = llvm.getelementptr %129[%132] : (!llvm.ptr, i64) -> !llvm.ptr, f16
        llvm.store %8, %133 : f16, !llvm.ptr
        %134 = llvm.extractvalue %60[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
